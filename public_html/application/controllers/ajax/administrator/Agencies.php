...
//        }
    ...
    public function addAgencyType($aParam) {
        ...
        $aParam['agency_id'] = $this->Agencies_model->addAgencyType($aParam);
        //user log
        $aLog = [];
        $aLog['log_event_type'] = 4; // base on table : icms_user_event_type
        $aLog['log_message'] = "added new agency " . $aParam['agencyname'] . " (" . $aParam['abbr'] . ")";
        $aLog['log_link'] = 'agencies/' . $this->yel->encrypt_param($aParam['agency_id']);
        ...
        if ($_SESSION['userData']['user_level_id'] !== "1") {
            $aNotif = [];
            $aNotif['method'] = "agencies";
            $aNotif['tbl_id'] = $aParam['agency_id'];
            $aNotif['receiver'] = $adminDetails['user_id'];
            $aNotif['notif_type'] = "4";
            $aNotif['msg'] = $_SESSION['userData']['user_firstname'] . "  " . $_SESSION['userData']['user_lastname'];
            $aNotif['msg'] .= "has added an agency<orange><a href='agencies/" . $this->yel->encrypt_param($aParam['agency_id']) . "'>";
            $aNotif['msg'] .= $aParam['agencyname'] . " (" . $aParam['abbr'] . ")";
            $aNotif['msg'] .= "</a></orange>";
        ...
        $aNotif['notif_type'] = "4";
        $aNotif['msg'] = "You added an agency<orange><a href='agencies/" . $this->yel->encrypt_param($aParam['agency_id']) . "'>";
        $aNotif['msg'] .= $aParam['agencyname'] . " (" . $aParam['abbr'] . ")";
        $aNotif['msg'] .= "</a></orange>";
        $this->notif->create($aNotif);

        $aParam['userid'] = $aParam['agency_id'];
    ...
    public function addAgencyBranch($aParam) {
        ...
        if ($_SESSION['userData']['user_level_id'] !== "1") {
            $aNotif = [];
            $aNotif['method'] = "agency_branch";
            $aNotif['tbl_id'] = $aParam['agency_id'];
            $aNotif['receiver'] = $adminDetails['user_id'];
            $aNotif['notif_type'] = "4";
            $aNotif['msg'] = $_SESSION['userData']['user_firstname'] . "  " . $_SESSION['userData']['user_lastname'];
            $aNotif['msg'] .= "has added new agency branch <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agency_id']) . "'>";
            $aNotif['msg'] .= $aParam['agntypename'] . " (" . $aParam['branchname'] . ")";
            $aNotif['msg'] .= "</a></orange>";
            $this->notif->create($aNotif);
        }
        ...
        $aNotif['receiver'] = $_SESSION['userData']['user_id'];
        $aNotif['notif_type'] = "4";
        $aNotif['msg'] = "You added an agency branch<orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agency_id']) . "'>";
        $aNotif['msg'] .= $aParam['agntypename'] . " (" . $aParam['branchname'] . ")";
        $aNotif['msg'] .= "</a></orange>";
        $this->notif->create($aNotif);
    ...
    public function getUserLevelWithCondition($aParam) {
        ...
        $adminCount = $this->Agencies_model->getAgencyAdminExist($aParam);
        $aParam['cond'] = " `transaction_parameter_type_id`='5' AND `transaction_parameter_status`='1' AND `transaction_parameter_count_id` = 1 ";
        if ($adminCount >= 1) {
            //$aParam['cond'] = " `transaction_parameter_type_id`='5' AND `transaction_parameter_status`='1' AND `transaction_parameter_count_id` >=2 ";
...
//            'status' => 'required',
        ...
        // add system notification to  admin
        $adminDetails = $this->Users_model->getSuperAdminUserId();
        if ($_SESSION['userData']['user_level_id'] !== "1") {
            $aNotif = [];
            $aNotif['method'] = "agencies";
            ...
            $aNotif['notif_type'] = "4";
            $aNotif['msg'] = $_SESSION['userData']['user_firstname'] . "  " . $_SESSION['userData']['user_lastname'];
            $aNotif['msg'] .= "has updated an agency details <orange><a href='agencies/" . $this->yel->encrypt_param($aParam['id']) . "'>";
            $aNotif['msg'] .= $aParam['agencyname'] . " (" . $aParam['abbr'] . ")";
            $aNotif['msg'] .= "</a></orange>";
            $this->notif->create($aNotif);
        }
        ...
        $aNotif['receiver'] = $_SESSION['userData']['user_id'];
        $aNotif['notif_type'] = "4";
        $aNotif['msg'] = "You have updated agency details <orange><a href='agencies/" . $this->yel->encrypt_param($aParam['id']) . "'>";
        $aNotif['msg'] .= $aParam['agencyname'] . " (" . $aParam['abbr'] . ")";
        $aNotif['msg'] .= "</a></orange>";
        $this->notif->create($aNotif);
...
//        $agency_branch_id = $this->Agencies_model->getAgencyBranchIDbyAgencyAddressId($aParam['addressid']);
        $agency_branch_id = $this->yel->decrypt_param($aParam['agn_id']);
        $aParam['agency_id'] = $agency_branch_id;
        ...
        if (isset($aLog['old_data']['address_list_id']) == false) {
            $aResponse['details'] = $this->Agencies_model->addNewAgencyAddress($aParam);
        } else {
        ...
        if ($_SESSION['userData']['user_level_id'] !== "1") {
            ...
            $aNotif['notif_type'] = "4";
            $aNotif['msg'] = $_SESSION['userData']['user_firstname'] . "  " . $_SESSION['userData']['user_lastname'];
            $aNotif['msg'] .= "has has updated the agency branch details <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agency_id']) . "'>";
            $aNotif['msg'] .= $aParam['agn_name'] . " (" . $aParam['agn_branch'] . ")";
            $aNotif['msg'] .= "</a></orange>";
            $this->notif->create($aNotif);
        }
        ...
        $aNotif['receiver'] = $_SESSION['userData']['user_id'];
        $aNotif['notif_type'] = "4";
        $aNotif['msg'] = "You just updated the agency branch <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agency_id']) . "'>";
        $aNotif['msg'] .= $aParam['agn_name'] . " (" . $aParam['agn_branch'] . ")";
        $aNotif['msg'] .= "</a></orange>";
        $this->notif->create($aNotif);
    ...
    public function setAgencyDetails($aParam) {
        ...
        // } else {
            ...
            if ($_SESSION['userData']['user_level_id'] !== "1") {
                $aNotif = [];
                $aNotif['method'] = "agency_branch";
                $aNotif['tbl_id'] = $aParam['agn_branch_id'];
                $aNotif['receiver'] = $adminDetails['user_id'];
                $aNotif['notif_type'] = "4";
                $aNotif['msg'] = $_SESSION['userData']['user_firstname'] . "  " . $_SESSION['userData']['user_lastname'];
                $aNotif['msg'] .= "has has updated the agency branch details <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agn_branch_id']) . "'>";
                $aNotif['msg'] .= $aParam['txt_agency'] . " (" . $aParam['branch_name'] . ")";
                $aNotif['msg'] .= "</a></orange>";
                $this->notif->create($aNotif);
            }
            ...
            $aNotif['receiver'] = $_SESSION['userData']['user_id'];
            $aNotif['notif_type'] = "4";
            $aNotif['msg'] = "You just updated the agency branch <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agn_branch_id']) . "'>";
            $aNotif['msg'] .= $aParam['txt_agency'] . " (" . $aParam['branch_name'] . ")";
            $aNotif['msg'] .= "</a></orange>";
            $this->notif->create($aNotif);
    ...
    public function setAgencyContact($aParam) {
        ...
        $aParam['id'] = $this->yel->decrypt_param($aParam['id']);
        $aParam['agency_id'] = $this->yel->decrypt_param($aParam['agn_id']);

        $aResponse['details'] = $this->Agencies_model->setAgencyContactDeleted($aParam);
        $aParam['contactid'] = $aParam['id'];
        //save user log
...
//            'address' => 'required',
        ...
        if ($aParam['action'] == "1") {
            ...
            // comment update contact address details 
        ...
        if ($_SESSION['userData']['user_level_id'] !== "1") {
            $aNotif = [];
            $aNotif['method'] = "agency_branch";
            $aNotif['tbl_id'] = $aParam['agencyid'];
            $aNotif['receiver'] = $adminDetails['user_id'];
            $aNotif['notif_type'] = "4";
            $aNotif['msg'] = $_SESSION['userData']['user_firstname'] . "  " . $_SESSION['userData']['user_lastname'];
            $aNotif['msg'] .= "has has updated the agency branch details <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agencyid']) . "'>";
            $aNotif['msg'] .= $aParam['agn_name'] . " (" . $aParam['agn_branch'] . ")";
            $aNotif['msg'] .= "</a></orange>";
            $this->notif->create($aNotif);
        }
        ...
        $aNotif['receiver'] = $_SESSION['userData']['user_id'];
        $aNotif['notif_type'] = "4";
        $aNotif['msg'] = "You just updated the agency branch <orange><a href='manage_agency_branch/" . $this->yel->encrypt_param($aParam['agencyid']) . "'>";
        $aNotif['msg'] .= $aParam['agn_name'] . " (" . $aParam['agn_branch'] . ")";
        $aNotif['msg'] .= "</a></orange>";
        $this->notif->create($aNotif);
        return $aResponse;
    ...
    public function getAgencyNameByKeyword($aParam) {
        ...
        $aResponse = [];
        $aResponse['result'] = self::FAILED_RESPONSE;
        $aResponse['list'] = $this->Agencies_model->getAgencyNameByKeyword($aParam);
        if (empty($aResponse['list']) == false) {
            $aResponse['result'] = self::SUCCESS_RESPONSE;
        }
        return $aResponse;
    }

    private function setNotificationForManageAgencyBranch($aParam) {
