                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card-title ">
                            ...
                            <small class="card-desc">List of all recruitment agencies and employers has associated
                                case.</small>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 float-right">
                                                <nav class="nav nav-inner-tab">
                                                    ...
                                                    <a class="nav-link txt-14 tab_local" data-toggle="tab"
                                                        ...
                                                        All Local Recruitment Agencies
                                                    </a>
                                                </nav>
                            ...
                            <div class="row px-3 mx-1 mt-3">
                                <div class="col-lg-6 col-sm-12 col-md-12 ">
                                    <div class="card-header card-sub-title bg-white p-0 m-0">
                                        ...
                                        <small class="card-desc"> List of all foreign recruitment agencies. </small>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-12 col-md-12 ">
                                    <div class=" list-action  list-action-filter">
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 float-right">
                                                <nav class="nav nav-inner-tab">
                                                    ...
                                                    <a class="nav-link txt-14 tab_foreign" data-toggle="tab" href=""
                                                        data-id="all_agency">
                                                        All Foreign Recruitment Agency
                                                    </a>
                                                </nav>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-name" name="txtAgencyName" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="email" id="txt-agency-email" name="txtAgencyEmail"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-website" name="txtAgencyWebsite"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-telephone" name="txtAgencyTelephone"
                                        class="form-control">
                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <label class="lbl">Fax Number </label>
                                    <input type="text" id="txt-agency-fax" name="txtAgencyFax" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-address" name="txtAgencyAddress"
                                        class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-owner" name="txtAgencyOwner" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <label class="lbl">Owner's Email</label>
                                    <input type="text" id="txt-agency-owner-email" name="txtAgencyOwnerEmail"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-owner-contact" name="txtAgencyOwnerContact"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" id="txt-agency-owner-address" name="txtAgencyOwnerAddress"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row">
                ...
                <form id="frm-emp-details" onsubmit="return false;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="text" id="txt-emp-name" name="txtEmpName" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <label class="lbl">Representative</label>
                            <input type="text" id="txt-emp-rep" name="txtEmpRep" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <label class="lbl">Contact Number</label>
                            <input type="text" id="txt-emp-contact" name="txtEmpContact" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <label class="lbl">Email Address</label>
                            <input type="text" id="txt-emp-email" name="txtEmpEmail" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="text" id="txt-emp-city" name="txtEmpCity" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <label class="lbl">Detailed Address</label>
                            <input type="text" id="txt-emp-address" name="txtEmpAddress" class="form-control">
                        </div>
                    </div>
                </form>
            </div>
