    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-body msgmodal-confirm-body m-body text-center">
                <p class="msgmodal-confirm-header m-header " style=" padding-top: 22px;"> You're about to add new agency.</p>
                <span class="sub-content-confirm p2">Click save button if you wish to continue.</span>
            </div>
            <div class="modal-footer msgmodal-confirm-footer m-footer "> 
                ...
                <div class="modal-body  msgmodal-warning-body" id="modal-body-update">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p class="mt-3"> You're about to add new agency.</p>
                        </div>
                    </div>
                </div>
            </div>

            <div class="modal-footer msgmodal-warning-footer m-footer pt-2"> 
                <button type="button" class="btn btn-close-warning-modal" data-dismiss="modal">Back</button>
            </div>
...
<footer>
    ...
    <script src="<?= SITE_ASSETS ?>library/plugin/amcharts4/core.js"></script>
    <script src="<?= SITE_ASSETS ?>library/plugin/amcharts4/charts.js"></script>
    <script src="<?= SITE_ASSETS ?>library/plugin/amcharts4/themes/animated.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"  crossorigin="anonymous"></script>


    <!-- Bootstrap JS library -->
    <script src="<?= SITE_ASSETS ?>global/template/bootstrap/js/bootstrap.min.js"></script>
    <script src="/assets/library/plugin/timeago.js"  type="text/javascript" ></script>
    <script src="/assets/modules/administrator/js/header.js"  type="text/javascript" ></script>
    <!--
