            ...
            <div class="modal-body ">
                ...
                <form id="form-create_global_model">
                    <div class="form-group">
                        ...
                        <input  class="form-control" id="inp-global_name" type="text" name="inp_global_name">
            ...
            <div class="modal-body ">
                ...
                <form id="form-update_global_model">
                    <div class="form-group">
                        ...
                        <input  class="form-control" id="inp-update-global_name" type="text" name="inp_update_global_name">
                ...
                <form id = "form-add_port">
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            <input type="text" id = "name_port_name" class="form-control" type = "text" name = "name_port_name">
                        </div>
                    </div>
            ...
            <div class="modal-body ">
                ...
                <form id = "form-manage_port">
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Port Name <font color="red">*</font> </label>
                            <input type="text" maxlength="50" id = "manage_port_name" class="form-control" type = "text" name = "manage_port_name">
                        </div>
                    </div>
            ...
            <div class="modal-body ">
                ...
                <form id = "form-data_dictionary">
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Term </label>
                            <input type="text" maxlength="20" id = "manage_term" class="form-control" type = "text" name = "manage_term">
                        </div>
                    </div>
            ...
            <div class="modal-body ">
                ...
                <form id = "form-add_data_dictionary">
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Term </label>
                            <input type="text" id = "add_term" class="form-control" type = "text" name = "add_term">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Description </label>
                            <textarea class="data-add_desc_textarea form-control" id = "add_description" name = "add_description" style="height: 175px! important;" rows="3" cols=""></textarea>
                        </div>    
                    </div>
            ...
            <div class="modal-body ">
                ...
                <form id = "form-add_tip_category">
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Name </label>
                            <input type="text" id = "add_tip_category_name" class="form-control" type = "text" name = "add_tip_category_name">
                        </div>
                    </div>                    
                    <div class="row">
                        <div class="form-group col-12">
            ...
            <div class="modal-body ">
                ...
                <form id = "form-update_tip_category">
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Name </label>
                            <input type="text" id = "update_tip_category_name" class="form-control" type = "text" name = "update_tip_category_name">
                        </div>
                    </div>                    
                    <div class="row">
                        <div class="form-group col-12">
            ...
            <div class="modal-body ">
                ...
                <form id = "form-add_services">
                    <div class="row">
                        <div class="form-group col-12">
                            <label> Name </label>
                            <input type="text" maxlength="50" id = "add_services_name" class="form-control" type = "text" name = "add_services_name">
                        </div>
                    </div>    
                    <div class="row">
                        <div class="form-group col-12">
