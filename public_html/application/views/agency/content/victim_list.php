                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <span class="text-left content-title"><a>List of Victim</a></span><br>
                                <small class="content-desc">List of all victims</small>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 text-right">
                                <div class="list-action" >
<!--                                    <input class="txt_search" id="txt_search-victim" type="search" placeholder="keyword..." aria-label="Search">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12" id="victim_list">
                            <div class="row-header">
                                <div class="row row-header-border">
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-header"><span class="padding-l-10">Victim Details </span></div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-header">Case Count</div>
                            ...
                            <div class="div-allcase-list1  case-list1" >
                                ...
                                <ul class=" list_content victim_list">
