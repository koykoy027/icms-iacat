            ...
            <div class="padding-l-15">
                <div class="fake-info-content bg-transparent" >
                    ...
                    <div class="row ">
                        ...
                        <div class="col-7 summary-details">
                            <label class="lbl-emp-deployment_country_value"></label>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-5 summary-lbl">
        ...
        <div class="col-lg-8 col-offset-4" >
            <div class="fake-info-content bg-transparent" >
                <div class="row ">
                    ...
                    <div class="col-8 summary-details">
                        <label  class='txt-justify lbl-case-facts'></label>
                    </div>
                </div>
        ...
        <div class="col-lg-8 col-offset-4" >
            <div class="fake-info-content bg-transparent" >
                <div class="row ">
                    ...
                    <div class="col-8 summary-details">
                        <label  class='txt-justify lbl-case-evaluation'></label>
                    </div>
                </div>
...
<div class="content-footer float-right  match-buttons">
    ...
    <button type="button" class="btn btn-previous_tab" data-tab="case">Previous</button>
