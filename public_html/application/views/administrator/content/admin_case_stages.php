                                                ...
                                                <div class="rowform-row">
                                                    <div class="mb-3 bg-white p-3">
                                                        <div class="form-group ">
                                                            <label for="inputState" class="blue  txt-W-500 pb-2">Dockeddddting and Assignment of Cases</label>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3 bg-white p-3">
                                                            ...
                                                            <div class="px-5">
                                                                ...
                                                                <!--                                                                <div class="row">
                                                                                                                                    <button type="submit" class="btn btn-primary-orange btn-next float-right" data-tab="employment" style="margin-left:0px;">Submit for Resolution</button>
                                                                                                                                </div>-->
                                                            </div>
