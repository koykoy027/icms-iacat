...
<body class="overflow-hidden access-wrapper">
    <div class="card access-container d-flex">
        <!-- <div class="row"> -->
        <!-- <div class="col-md-5 col-sm-12 col-lg-5">
                <div class="d-flex justify-content-end">
                    <p class="four-o-one"> Access Denied </p>
                </div>
            </div> -->

        <div class="card card-four-o-one d-block ml-5 m-auto">
            ...
            <div class="px-5 py-0" style="display: none;">
                <p class="d-flex justify-content-center align-items-center access__p text-align_center">The page
                    or resource you were trying to to reach is absolutely forbidden for some reason</p>
            </div>
            <a href="javascript:history.back()">
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-block btn-go_back mt-2"><i class="fas fa-arrow-left"></i>
                        Go Back</button>
                </div>
            </a>
        </div>
