                ...
                <div class="row tab-header mt-3">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <ul class="nav nav-pills nav-fill case-ul" id="case-ul" data-id="1">
                            ...
                            <li class="nav-item nav-inner-item li-tagged-cases lvl-ce lvl-ch lvl-ca lvl-ra">
                ...
                <div class=" card-stats-inner ">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="tab-content mgn-T-18 " id="myTabContent">
                            <!--ALL CASE TAB-->
                            <div class="tab-pane fade show active lvl-ce lvl-ch lvl-ca lvl-ra" id="all_case_tab"
