                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                                    ...
                                                                    <div class="personal-info-sub_forms">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 px-0">
                                                                            ...
                                                                            <div class="row ">
                                                                                ...
                                                                                <div class="col-lg-9 col-md-9 col-sm-9 card-sub-title blue txt-W-500 mb-0">
                                                                                    <div class=" mt-1 show list-action-filter float-right">
                                                                                        ...
                                                                                        <div class="d-inline-block">
                                                                                            <button type="button" class="btn btn-primary-orange "  data-toggle="modal"  data-target="#mdl_trial" id="btn-trig-mdl_trial">
            ...
            <div class="modal-body msgmodal-body" style='overflow-y: scroll; height:950px;'>
                ...
                <div class="row mgn-L-15 form-row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="form-group">
                            <label >Remarks</label>
                            <textarea class="form-control case-evaluation" style="height: 150px !important;" ></textarea>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="row">
...
<!--stage 7-->
<div class="modal fade " id="mdl_trial"  role="dialog" data-backdrop="static" aria-modal="true">
