 ...
 * 
 * @modification    v 3.2
 * @author          LBS eBusiness Developer
 * @since           2019
 */
/*
 * ---------------------------------------------------------------
...
/**
 * -------------------------------------------------------------------
 * Deep Path | for Drive , Session and external path
 * -------------------------------------------------------------------
 */
// global use | document|directory seperator
define('DS', '/');

// base directory 
$mPath = @explode(DS, rtrim($_SERVER['DOCUMENT_ROOT'], DS));
array_pop($mPath);
$mBasePath = @implode(DS, $mPath);
define('DEEP_DIR', $mBasePath . DS);

// cloudflare overwrite ip
