...
$message .= '        <title>JobOpps: Forgot Password</title>';
$message .= '        <style type="text/css">';
$message .= '        </style>';
$message .= '    </head>';

$message .= '    <body style="font-family:Arial,Helvetica,sans-serif;font-size:13px;background-color:#f2f2f4;color:#222;">';
$message .= '        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="email-container">';
$message .= '            <tr>';
...
$message .= '                                        <td style="font-size:22px;color:#ffffff;padding-left:20px;" valign="bottom">We are here to help you</td>';
...
$message .= '                                    <tr>';
$message .= '                                        <td style="background-color:#ffffff;padding-top:20px;padding-right:20px;padding-bottom:0;padding-left:20px; " align="center" valign="top">';
$message .= '                                           <h2 style="color:#0d9aac;">Forgot Password Request</h2>';

$message .= '                                            <p>';
$message .= '                                                You recently requested to reset your password for your account.';
$message .= '                                                Click the button below to reset it.';
$message .= '                                            </p>';
$message .= '                                            <br/>';

$message .= '                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">';
$message .= '                                                <tr>';
$message .= '                                                    <td  style="background-color:#fafafa; padding: 5% 2%;">';
//$message .= '                                                  <td style="text-align: center; "> <a href="' . $aMailContent['data']['reset_link'] . '" style="display:inline-block;width:130px;text-align:center;background-color:#dcb026;color:#ffffff;text-decoration:none;text-transform:uppercase;padding:10px;margin:5px;">VISIT NOW</a> </td>';
$message .= $aMailContent['data']['reset_link'];
$message .= '                                                    </td>';
$message .= '                                                </tr>';
$message .= '                                            </table>';
$message .= '                                            <p>';
$message .= '                                                If you did not request this password reset, please ignore this email or email us to let us know that you did not authorize this.';
$message .= '                                            </p><br>';
