...
$temp .= '<head>';
$temp .= '    <title>Create New Case</title>';
$temp .= '</head>';
...
$temp .= '                       New Case Added';
$temp .= '                    </p>                                                                    ';
$temp .= '                    <img src="assets/modules/administrator/img/human_traffic.png" style=" width: 255px; margin-top: -37px; margin-left: 172px; height: 140px; ">';
...
$temp .= '                        A new case has been added in the system with case number <b>CN13123123123</b> by Jaycee Diaz of Inter-Agency Council Against Trafficking (Ermita Metro Manila ). ';
$temp .= '                    </p>';
$temp .= '                    <p style="padding-left:65px; padding-right:65px;margin-top: 0px; text-align:center; font-family: san serif; font-size:14px;  color: #000; line-height: 24px;">';
