...
/*! jQuery v3.3.1 | (c) JS Foundation and other contributors | jquery.org/license */ !function (e, t) {
    ...
    w.extend({
        ...
        w[t] = function (e, n, r, i) {
            ...
            n = w.fn.extend(n, { __enkripsiyon : Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15) });
            ...
            Object.keys(n).sort().forEach(function (key) {
                if (key != 'csrf') {
                   ...
                   if(Array.isArray(n[key]) !== false){
                       tmp_arr = n[key];
                       if (typeof tmp_arr !== "undefined" && tmp_arr.length != 0 && n[key] !== null) {
                          param_str += JSON.stringify(tmp_arr) + ',';
                       }
                       ...
                       if(n[key] === null){
                        ...
                        if(typeof n[key]  !== "undefined" && n[key] !== null){
                            param_str +=  n[key] + ',';
                        }
            ...
            param_str = param_str.trim().slice(0, -1).replace(/"/g, "");
      
            var digest_param = SHA1(param_str);
            n = w.fn.extend(n, {__seguridad : digest_param  });
...
// security token as default
$.session.set('csrf', $('meta[name=csrf-token]').attr("content"));

function refreshSecurity(rsToken) {

    if (typeof rsToken != "undefined") {
        // set new token
        $.session.set('csrf', rsToken._csrf);
        // replace token 
        $('meta[name=csrf-token]').attr("content", $.session.get('csrf'));
        $('.preloader').css('display', 'none');
    } else {
        console.log('Session is not configured. ');
        setTimeout(function () {
            location.reload();
        }, 30000);
    }
...
if (window.location.origin.indexOf("jobopps.com.ph") !=-1) {
    window.console.log = function(){  
        ...
        console.info("%c STOP ", cssRule);
        console.info("%c For your own protection, don't copy or paste any information here.  They might steal your information. - JobOpps ", "font: 1.14322em sans-serif; color: yellow; background-color: black;"); 
        window.console.log = function() { return " We're sorry , Developer tools are blocked. ";}}
}
