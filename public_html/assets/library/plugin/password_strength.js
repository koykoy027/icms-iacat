        ...
        return {
            calculate: function (value, points) {
                ...
                if (passwordContainsSpaces(value)) {
                    score += countSpaces(value) * points.forEachSpace;
                }
                if (passwordContainsLowercaseLetter(value)) {
                    score += points.containsLowercaseLetter;
                }
                if (passwordContainsUppercaseLetter(value)) {
                    score += points.containsUppercaseLetter;
                }
                if (passwordContainsNumber(value)) {
                    score += points.containsNumber;
                }
                if (passwordContainsSymbol(value)) {
                    score += points.containsSymbol;
                }
    ...
    function Indicator(indicator, settings) {
        ...
        return {
            refresh: function (score) {
                ...
                if (settings.text) {
                    //$indicator.html("<span style='color:black'>Password Strength : </span>" + strengthClass.text);                    
                    $indicator.html("<span class='blue'>Password Strength: " + strengthClass.text + " </span>");
                }
            }
        };
    }
