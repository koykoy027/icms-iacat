    ...
    if (id != null) {
        ...
        $.post(sAjaxAgencies, {
            ...
            if (rs.data.flag !== '0') {
                ...
                l += ' <p class="content-title" style="text-align:center;">Agency Branch Details</p>';
                l += '        <div style="padding: 0em 3em;">';
                l += '            <div class="row">';
                l += '                <div class="col-lg-3 col-md-3 col-sm-12">';
                l += '                        <img src="' + sDriveViewer + res.logo + '" onerror="ifBrokenLogo(this);" style="margin-top: 25px; height:80px; width:80px">';
                l += '                    ';
                l += '                </div>   ';
                l += '                <div class="col-lg-9 col-md-9 col-sm-12">';
                l += '                    <h5 class="card-title" >';
                l += '                          <span>' + res.agency_name + '</span>';
                l += '                          <p><br><small>' + res.agency_abbr + ' - ' + res.agency_branch_name + '</p>';
                l += '                     </h5>';
                l += '                     <p>';
                l += '                      ' + res.agency_branch_email;
                ...
                l += '             <div class = "col-lg-12 col-md-12 col-sm-12">';
                l += '                <p> ' + res.agency_branch_description + '</p>';
                l += '             </div>';
                if (res.contact_details_result == "1") {
                    l += '             <div class = "col-lg-12 col-ms-12 col-sm-">';
                    l += '                <p class="card-title">  Agency Contact Details  </p>';
//                    l += '                <span class="card-desc"> List of agency contact details </span>';
                    ...
                    $.each(res.contact_details, function (key, val) {
                        l += '                    <b>' + val.agency_contact_firstname + ' ' + val.agency_contact_lastname + '</b>';
                        l += '<br><br><br>';
                        if (val.agency_contact_mobile_number !== "" && val.agency_contact_telephone_number !== "") {
                            l += '<p>' + val.agency_contact_mobile_number + ' |  ' + val.agency_contact_telephone_number + '</p>';
                        } else {
                            if (val.agency_contact_telephone_number !== "") {
                                l += '<p>' + val.agency_contact_telephone_number + '</p>';
                            }
                            if (val.agency_branch_mobile_number !== "") {
                                l += '<p>' + val.agency_branch_mobile_number + '</p>';
                            }
                        }
                        ...
                        if (typeof val.country_name !== "undefined") {
                            l += '                    <p style="text-transform:capitalize">' + val.brgy + ' ' + val.city + ' ' + provState + ', ' + val.country_name + '</p>';
                        }
                ...
                sFooter += '<button type="button" class="btn btn-close" data-dismiss="modal">Close</button>';
...
function buildBranchList(rs) {
    ...
    $.each(rs.data.content.listing, function (key, val) {
        ...
        tbl += '                        </span><br>   <span style="color:  #356397;">  ' + val.agency_name + '     (' + val.agency_abbr + ')   </span> <br> ';
        tbl += '                                                       <span style="color:#495057;">';
        ...
        if (typeof val.address.country !== "undefined") {
            ...
            tbl += ' <span style="text-transform:capitalize">' + val.address.address_list_address + '  , ' + val.address.city + ' , ' + val.address.province + ' </span><br>';
        }
