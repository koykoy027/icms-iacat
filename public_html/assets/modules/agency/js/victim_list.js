...
function buildVictimList(res) {
    ...
    $.each(res, function (key, val) {
        l += '  <li style="width:100%;font-size: 14px;" class="victim-list-content">';
        l += '                               <div class="card" >';
        l += '                                   <div class="row">';
        l += '                                       <div class="col-lg-7 col-md-7 col-sm-7  align-items-center be-view-victim" attr-id = "' + val.victim_id + '">';
        l += '                                           <span class="victim-id">#' + val.victim_number + ' </span> ';
        l += '                                            <div class="nav-data_list " >';
        l += '                                               <div class="agency_details"> ';
//        l += '                                                     <span style="color:  #356397; font-weight:600;">  ' + val.info.victim_info_first_name + ' ' + val.info.victim_info_middle_name + ' ' + val.info.victim_info_last_name + ' ' + val.info.victim_info_suffix + ' </span>';
        if (val.assumed_full_name) {
            l += '                                                     <span style="color:  #356397; font-weight:600;">  Real name : </span> <span style="font-weight:600;">  ' + val.real_full_name + ' </span>';
            l += '                                                     <br> <span style="color:  #973535; font-weight:600;">  Assumed name : </span> <span style="font-weight:600;">  ' + val.assumed_full_name + ' </span>';
        } else {
            l += '                                                     <span style="font-weight:600;"> ' + val.real_full_name + ' </span>';
        }
        ...
        l += '                                                         </span>';
//        l += val.address_list.brgy + ', ' + val.address_list.city + ', ' + val.address_list.province + ' </span>';
//        l += '                                                        <br> <span>' + val.contact_details.victim_contact_detail_content + '</span>';
        l += '                                                </div>';
        l += '                                            </div>';
        l += '                                        </div>';
        l += '                                       <div class="col-lg-3 col-md-3 col-sm-3 txt-align_center d-flex align-items-center be-view-victim" attr-id = "' + val.victim_id + '"> <span class="badge badge-light"> ' + val.count_associated_case + ' Associated Case</span></div>';
        ...
        l += '                                                    <a class="dropdown-item a-view_victim_profile lvl-ch" attr-id="' + val.victim_id + '" data-toggle="modal" data-target="#mdl-victim_info"> Victim Profile</a> ';
        l += '                                           </div>';
        l += '                                       </div>';
        l += '                                   </div>';
        l += '                               </div>';
