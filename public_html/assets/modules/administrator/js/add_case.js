    ...
    var victim_personal_contact_info = [
      {
        ...
        contact_type_name: $(".a-vi-contact_type option:selected").attr(
          "data-name"
        ),
...
function storeVictimEducationInfo() {
  ...
  if (!storage) {
    var victim_personal_education_info = [
      {
        ...
        education_type_name: $(".a-vi-education_type option:selected").attr(
          "data-name"
        ),
    ...
    _setStorageData(
      victim_personal_education_info,
      "victim_personal_education_info"
    );
  } else {
    var victim_personal_education_info = {
...
function storeVictimEducationInfoById() {
  ...
  //get name of type
  current[storedId]["education_type_name"] = $(
    ".u-vi-education_type option:selected"
  ).attr("data-name");
...
function storeVictimAddressInfoById() {
  ...
  var l = "";
  l += $(".u-vi-address_region option:selected").attr("data-name")
    ? $(".u-vi-address_region option:selected").attr("data-name") + ", "
    : "";
  l += $(".u-vi-address_province option:selected").attr("data-name")
    ? $(".u-vi-address_province option:selected").attr("data-name") + ", "
    : "";
  l += $(".u-vi-address_city option:selected").attr("data-name")
    ? $(".u-vi-address_city option:selected").attr("data-name") + ", "
    : "";
  l += $(".u-vi-address_barangay option:selected").attr("data-name")
    ? $(".u-vi-address_barangay option:selected").attr("data-name") + ", "
    : "";
  l += $(".u-vi-address_complete").val()
    ? $(".u-vi-address_complete").val() + " "
    : "";
  ...
  //get name of type
  current[storedId]["address_type_name"] = $(
    ".u-vi-address_type option:selected"
  ).attr("data-name");
    ...
    var victim_personal_relative_info = [
      {
        ...
        relative_primary_contact_number: $(
          ".a-vi-relative_primary_contact_number"
        ).val(),
        relative_secondary_contact_number: $(
          ".a-vi-relative_secondary_contact_number"
        ).val(),
        relative_email: $(".a-vi-relative_email").val(),
        relative_other:
          $(".a-vi-relative_type option:selected").attr("data-name") == "Other"
  ...
  if (relatives.length > 0) {
    $.each(relatives, function (key, val) {
      ...
      if (
        ...
        t +=
          '<td> <div class="btn-group ellipse-action" data-id="vi-relative_info_list' +
          cnt +
          '" data-tab="">';
        t +=
        ...
        t +=
          '<a class="dropdown-item up-victim_relative_info" data-id="' +
          cnt +
          '" >Update</a>';
        t +=
          '<a class="dropdown-item rm-victim_relative_info" data-id="' +
          cnt +
          '" ' +
          relative_id +
          ">Remove</a>";
...
function initialLoad() {
  ...
  if (temp_data.flag == 1) {
    ...
    setTimeout(function () {
      ...
      $(".v-deployment_country").val(
        temp_data.temporary_victim_country_deployment
      );
      ...
      $(".emp-deployment_departure_type").val(
        temp_data.temporary_victim_departure_type
      );

      $(".case-complainant_name").val(
        temp_data.temporary_complainant_firstname +
          " " +
          temp_data.temporary_complainant_middlename +
          " " +
          temp_data.temporary_complainant_lastname
      );
      $(".case-complainant_contact").val(
        temp_data.temporary_complainant_mobile_number
      );

      $(".case-complainant_relation").val(
        temp_data.temporary_complainant_relation
      );
      $(".case-complainant_relation_other").val(
        temp_data.temporary_complainant_relation_other
      );

      $(".case-complainant_address").val(
        temp_data.temporary_complainant_address
      );
...
function loadVictimInfoIfExist() {
  ...
  //   this where the problem in existing code i was debugging it.
  ...
  $.post(
    ...
    function (rs) {
      if (rs.data.flag == "1") {
        ...
        console.log(aVContent.real.victim_info_first_name);
        ...
        $(".vi-sex").val(aVDetails.gender_name).text(aVDetails.gender_name);
        console.log(aVDetails.gender_name);
        $(".vi-civil").val(aVDetails.civil_status_name).change();
        $(".vi-religion").val(aVDetails.victim_religion).change();

        $(".vi-assumed_first_name ").val(
          aVContent.assumed.victim_info_first_name
        );
        $(".vi-assumed_middle_name").val(
          aVContent.assumed.victim_info_middle_name
        );
        ...
        if (aVContent.victim_relatives_info.length > 0) {
          ...
          $.each(aVContent.victim_relatives_info, function (key, val) {
            var victim_personal_relative_info = {
              ...
              relative_primary_contact_number:
                val.victim_relative_primary_contact_number,
              relative_secondary_contact_number:
                val.victim_relative_second_contact_number,
...
function setDetailsBasedOnValidate() {
  ...
  $(".emp-local_agency_name").val(
    localStorage.getItem("local_recruitment_agency")
  );

  $(".emp-deployment_date").val(localStorage.getItem("deployed_date"));
  $("#emp-sel-eer-country")
    .val(localStorage.getItem("deployment_country"))
    .change();
  $("#cd-sel-purposes")
    .val(localStorage.getItem("traffic_purpose"))
...
$(document).ready(function () {
  ...
  $(".victim-contact_info_list").delegate(
    ".rm-victim_contact_info",
    "click",
    function () {
      var id = $(this).attr("data-id");
  ...
  $(".victim-contact_info_list").delegate(
    ...
    function () {
      ...
      if (x[id]["conctact_details_id"]) {
        $("#form-update_contact_info").attr(
          "data-id",
          x[id]["conctact_details_id"]
        );
      }
  ...
  $(".victim-education_info_list").delegate(
    ".rm-victim_education_info",
    "click",
    function () {
      var id = $(this).attr("data-id");
  ...
  $(".victim-education_info_list").delegate(
    ...
    function () {
      ...
      if ($(".u-vi-education_type").val() == "13") {
        ...
        if (
          f ||
          educ_type == "High School Graduate" ||
          educ_type == "High School Undergraduate"
        ) {
          $(".field-education_course").hide();
        } else {
          $(".field-education_course").show();
      ...
      if (x[id]["victim_education_id"]) {
        $("#form-update_education_info").attr(
          "data-id",
          x[id]["victim_education_id"]
        );
      }
  ...
  $(".u-vi-education_type").change(function () {
    ...
    if ($(this).val() == "13") {
      ...
      if (
        f ||
        str == "High School Graduate" ||
        str == "High School Undergraduate"
      ) {
        $(".field-education_course").hide();
      } else {
        $(".field-education_course").show();
  ...
  $(".victim-address_info_list").delegate(
    ".rm-victim_address_info",
    "click",
    function () {
      var id = $(this).attr("data-id");
  ...
  $(".victim-relative_info_list").delegate(
    ".rm-victim_relative_info",
    "click",
    function () {
      var id = $(this).attr("data-id");
  ...
  $(".victim-relative_info_list").delegate(
    ...
    function () {
      ...
      var selected = $(".u-vi-relative_type option:selected")
        .text()
        .toLowerCase()
        .replace(" ", "");
      if (selected === "other") {
  ...
  $(".validate-add-new-btn").click(function () {
    ...
    icmsMessage({
      type: "msgConfirmation",
      title:
        "You are about to add new rerpot to <br> <em>" +
        $(".msgmodal-header .vic-name").text() +
        "</em>",
      body: "Click continue button if you wish to continue.",
      LblBtnConfirm: "Continue",
      onConfirm: function () {
        ...
        $(".vi-first_name").val(localStorage.getItem("victim_info_first_name"));
        $(".vi-middle_name").val(
          localStorage.getItem("victim_info_middle_name")
        );
        $(".vi-last_name").val(localStorage.getItem("victim_info_last_name"));
        $(".vi-dob").val(localStorage.getItem("victim_info_dob"));
        $(".vi-pob").val(localStorage.getItem("victim_info_city_pob"));
        ...
        $(".emp-deployment_date").val(localStorage.getItem("deployed_date"));
        $(".emp-deployment_country").val(
          localStorage.getItem("deployment_country")
        );
        loadVictimInfoIfExist();
      },
      onCancel: function () {
            ...
            if (rs.data.flag != "0") {
              ...
              $.each(rs.data.list, function (key, val) {
                l +=
                  ...
                  val.recruitment_agency_id +
                  "'>" +
                  val.recruitment_agency_name +
                  "</li>";
              });
  ...
  $("#validate-local-search").delegate(
    ".list-group-item",
    "click",
    function () {
      var name = $(this).text();
  ...
  $("#validate-employer-search").delegate(
    ".list-group-item",
    "click",
    function () {
      var name = $(this).text();
  ...
  $(".a-vi-relative_type").change(function () {
    var selected = $(".a-vi-relative_type option:selected")
      .text()
      .toLowerCase()
      .replace(" ", "");
  ...
  $("#validate-local-search").delegate(
    ...
    function () {
      ...
      $("#form-validate_victim .v-local_recruitment_agency").attr(
        "data-id",
        id
      );
